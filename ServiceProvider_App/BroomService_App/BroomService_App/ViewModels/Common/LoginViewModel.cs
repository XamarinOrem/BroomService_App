                            ...
                            if (!string.IsNullOrEmpty(Email) && !string.IsNullOrEmpty(Password) && !string.IsNullOrWhiteSpace(Email) && !string.IsNullOrWhiteSpace(Password))
                            {
                                ...
                                if (response != null)
                                {
                                    if (response.status)
                                    {
                                        ...
                                        {
                                            Console.WriteLine("UpdateDeviceApiLogin_Exception:-->" + ex.Message);
                                        ...
                                        userTypeEnum = response.userData.UserType.Value;
                                        if (response.userData.UserType == Convert.ToInt32(UserTypeEnum.ServiceProvider))
                                        {
